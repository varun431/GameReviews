...
//            mUserId = mFirebaseUser.getUid();
            ...
            String[] characterArray = {"Serena van der Woodsen", "Blair Waldorf", "Dan Humphrey", "Nate Archibald", "Chuck Bass", "Vanessa Abrams", "Jenny Humphrey", "Eric van der Woodsen", " Lily van der Woodsen", "Rufus Humphrey"};

            final ArrayAdapter<String> adapter = new ArrayAdapter<>(this, R.layout.list_view, characterArray);
